...
//     colors: [
//       // cardBgColor,
//       // const Color.fromARGB(255, 13, 61, 100),
//       // const Color.fromARGB(255, 75, 55, 24),
//       // const Color.fromARGB(255, 105, 24, 51),
//        const Color.fromARGB(255, 16, 100, 13),
//       const Color.fromARGB(255, 102, 17, 130),
     
//       const Color.fromARGB(255, 29, 19, 81),
//       const Color.fromARGB(255, 113, 11, 45),
//     ]);
var linearGradient = LinearGradient(
  begin: Alignment.topLeft,
  end: Alignment.bottomRight,
  ...
  colors: [
    ...
    // Color.fromARGB(255, 23, 5, 64), // Dark Violet
    // Color.fromARGB(255, 73, 9, 115), // Royal Purple
     Color(0xFF000000), // Absolute Black
    Color(0xFF1B1B2F), // Deep Indigo
