                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: PopularCard(
                        turfModel: (index==0)?state.turfModels[0].last:(index==1)?state.turfModels[1].last:state.turfModels[1].first,
...
class FootballItemCardWidget extends StatelessWidget {
  ...
  FootballItemCardWidget(
      {super.key, required this.screenWidth, required this.index,required this.turfModel});
